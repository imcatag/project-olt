...
while True:
    ...
    if message.type == "play":
        ...
        print("placing piece", agent.state.activePiece.name, "at", message.move.location.x, message.move.location.y, "with rotation", message.move.location.orientation, "and spin", message.move.spin)
    ...
    print(agent.state.activePiece)
    print(agent.state.holdPiece)
    print(agent.state.queue)
    print("!!!!")